  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden h-[calc(100vh-4rem)] flex flex-col justify-between">
          {[basicNavigationItems, systemNavigationItems].map((navItems) => (
            <div className="p-4 pl-6 space-y-2" key={navItems[0].title}>
              <GroupNavigation
                navItems={navItems}
