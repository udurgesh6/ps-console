...
export default function DashboardLayout({
  ...
  return (
    <div className="h-full bg-gray-50">
      ...
      <main
        className="pt-18 pb-10 bg-gray-100 min-h-screen flex-1 overflow-y-auto transition-all duration-300 ease-in-out hidden md:block"
        style={{
      ...
      <main className="pt-16 transition-all duration-300 ease-in-out block md:hidden">
        <div className="p-4 px-7 bg-gray-100">{children}</div>
      </main>
    </div>
  );
}
