...
export const sampleEmailTemplates: LibraryItem[] = [
  {
    id: "1",
    name: "Chat message",
    title: "Chat message",
    description: "Quick communication template",
    provider: "Google",
    category: "everyone",
    tags: ["chat", "message"],
    subject: "Quick Update: Design Files Updated",
    logo: "/phish-sheriff-small.png",
...
<html lang="en">
  ...
  },
  {
    ...
    description: "Handle access permissions",
    provider: "Google",
    category: "everyone",
    tags: ["access", "security"],
    subject: "🔐 Access Request: Project Phoenix - Design Files",
    logo: "/phish-sheriff-small.png",
    htmlTemplate: `<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  {
    id: "3",
    name: "A new document is available",
    title: "A new document is available",
    description: "Document sharing notification",
    provider: "Google",
    category: "everyone",
    tags: ["document", "sharing"],
    subject: "📄 New Document Shared: Q4 Marketing Strategy.pdf",
    logo: "/phish-sheriff-small.png",
    htmlTemplate: `<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  },
  {
    ...
    subject: "⚠️ Account Security Alert - Immediate Action Required",
    logo: "/phish-sheriff-small.png",
    htmlTemplate: `<!DOCTYPE html>
<html lang="en">
  <head>
